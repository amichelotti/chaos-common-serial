...
PosixSerialComm::PosixSerialComm(std::string serial_dev,int _baudrate,int _parity,int _bits,int _stop,bool _hw,int _write_buffer_size,int _read_buffer_size):comm_dev(serial_dev),baudrate(_baudrate),parity(_parity),bits(_bits),stop(_stop),hwctrl(_hw),read_buffer(NULL),read_buffer_size(_read_buffer_size),w_read_buffer_ptr(0),r_read_buffer_ptr(0){
